...
4. **위험종목·관리종목 제외**
   ...
   - 한국: **LS증권 OpenAPI 적용** (관리종목·거래정지·정리매매 제외 / 투자경고·투자주의·단기과열은 참고 배지로만 표시, 제외 안 함) — 2026-05-21
5. **중국기업 제외** (미국주식 한정)
...
- **관리종목 필터 LS증권 OpenAPI 로 해소** (2026-05-21): 관리종목·거래정지·정리매매 제외 적용 / 투자경고·투자주의·단기과열은 참고 배지
...
## 보류된 항목
- ~~한국 관리종목/위험종목 필터 데이터 소스~~ → **해소 (2026-05-21)**: LS증권 REST OpenAPI 로 관리/거래정지/정리매매 제외 적용. 키는 조회전용 + GitHub Secrets. KIS 대신 LS 채택.
