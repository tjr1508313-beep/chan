---
name: 미국주식 데이터 API
description: 미국주식 외부 데이터 소스(yfinance/Finnhub/Polygon 등) 연동 전담 - 나스닥/S&P500 종목 리스트, 일봉 시세, 메타데이터(섹터/국가/한글명) 수집. 한국주식/코인 데이터 API와는 완전히 독립.
---
